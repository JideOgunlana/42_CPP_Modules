...
/*   Updated: 2023/05/24 01:26:45 by bogunlan         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void Bureaucrat::executeForm(AForm const & form) {
	if (this->getGrade() > form.getExecGrade()) {
		std::cout << this->getName() << " grade is " << this->getGrade() <<  ", therefore, cannot execute " << form.getFormName() << " of execution grade " << form.getExecGrade() << std::endl;
	}
	else {
