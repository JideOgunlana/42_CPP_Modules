...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/04/03 15:20:57 by bogunlan          #+#    #+#             */
/*   Updated: 2023/04/12 17:19:15 by bogunlan         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap&	ClapTrap::operator=(ClapTrap const &rhs) {
	...
	if (this->_hit_points != rhs.getHitPoints())
		this->_hit_points = rhs.getHitPoints();
	if (this->_attack_damage != rhs.getAttackDamage())
		this->_attack_damage = rhs.getAttackDamage();
	if (this->_energy_points != rhs.getEnergyPoints())
